...
href="index.php?page_layout=product&prd_id='.$prd_id.'&page='.$page_prev.'">&laquo;</a></li>';
...
$list_pages .= '<li class="page-item"><a class="page-link" 
href="index.php?page_layout=product&prd_id='.$prd_id.'&page='.$page_next.'">&raquo;</a></li>';
...
?>
                ...
                <div id="product">
                	<div id="product-head" class="row">
                        ...
                        <div id="product-details" class="col-lg-6 col-md-6 col-sm-12">
                            ...
                            <ul>
                                ...
                                <li id="price-number"><?php echo number_format($row['prd_price'], 2, ',', '.').' VNĐ'; ?></li>
                                <li id="status"><span>Tình trạng:</span>  <?php if($row['prd_status']==1){ echo 'còn hàng';}else{echo 'hết hàng'; }  ?></li>
                            </ul>
                            <div id="add-cart"><a href="index.php?page_layout=cart&prd_id=<?php echo $row['prd_id']; ?>">Mua ngay</a></div>
                        </div>
                    </div>
                    <div id="product-body" class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <h3>chi tiết về sản phẩm <?php echo $row['prd_name']; ?> </h3>
                            <p>
                    ...
                    if(isset($_POST['sbm'])){
                        ...
                        $sql = "INSERT INTO
                        comment(prd_id, comm_name, comm_mail, comm_details, comm_date)
                        VALUES('$prd_id', '$comm_name', '$comm_mail', '$comm_details', '$comm_date')";
                        $query = mysqli_query($conn, $sql);
                        
                        // header("location:index.php?page_layout=product&prd_id=$prd_id&page=1 ");
