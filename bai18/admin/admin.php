...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="<?php if($_GET['page_layout'] == 'comment'){ echo 'active';} ?>"><a href="index.php?page_layout=comment"><svg class="glyph stroked bag"><use xlink:href="#stroked-bag"></use></svg>Quản lý bình luận</a></li>
			...
			<li><?php echo $_SESSION['pass']   ?></li>
			<li><?php echo $_SESSION['sql']   ?></li>
