                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="form-group">
                                            ...
                                            <a onclick="return delItem('<?php echo $row['prd_name'];?>')" href="del_product.php?prd_id=<?php echo $row['prd_id']?>&prd_name=<?php echo $row['prd_image']; ?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i></a>
                                        </td>
                                    </tr>
                                   <?php } ?>
                                 </tbody>
