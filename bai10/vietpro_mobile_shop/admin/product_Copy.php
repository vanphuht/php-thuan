...
$rows_per_page = 5;
$per_row = $page * $row_per_page - $rows_per_page;
// truy vấn
$total_rows = mysqli_num_row(mysqli_query($conn, "SELECT * FROM product"));
$total_pages = ceil($total_rows/$rows_per_page);// hàm làm tròn trang
// code nút prev page
$list_pages = '';
$page_prev = $page - 1;
if($page_prev<=0){
...
$list_pages .= '<li class="page-item"><a class="page-link" href="index.php?page_layout=product&page='.$page_prev.">&raquo;</a></li>'
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><span class="label <?php if($row['prd_status']==1){echo 'lable-success';}else{echo 'label-danger';} ?>"><?php if($row['prd_status']==1){echo 'còn hàng';}else{echo 'hết hàng';} ?></span></td>
