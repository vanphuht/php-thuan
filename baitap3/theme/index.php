...
// if(isset($_GET[langgues])){
//     $langgues=$_GET["langgues"];
// }
// $data = file_get_contents('en.json');
...
// dọc file json
$data_lang= file_get_contents($lang.'.json');
// chuyển sang dạng mảng
$result_array = json_decode($data_lang, true);
?>
...
<div id="header" class="fixed-top">
	<div class="container">
		<div class="row">
			...
			<div id="language" class="col-lg-2 col-md-2 col-sm-12"><a href="index.php?lang=vi">Việt Nam</a> | <a href="index.php?lang=en">England</a></div>
		</div>
	</div>
</div>
<div id="body">
                ...
                <div class="card">
                    <div class="header">
                        <h2>
                            ...
                            <small><?php echo  $result_array['description']; ?>.</small>
                        </h2>
                    </div>
                    <div class="body table-responsive">
                        <table class="table table-condensed">
                            <thead>
                                <tr>
                                    <th width="10%">#</th>
                                    <th width="60%"> <?php echo  $result_array["name"]; ?></th>
                                    <th width="15%" class="text-center"><?php echo  $result_array["preview"]; ?></th>
                                    <th width="15%" class="text-center"><?php echo  $result_array["download"]; ?></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr class="active">
