...
// up ảnh
    $prd_image = $_FILE['prd_image']['name'];
    $prd_image_tmp_name = $_FILE['prd_image']['tmp_name'];
    $cat_id = $_POST['cat_id'];
...
// kiểm tra nút nổi bật
    if(isset($_POST['prd_featured'])){
        ...
        //upload
        move_upload_file($prd_image_tmp_name, 'img/products/'.$prd_image);
        // chuyển hướng trở về trang product
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php 
                                        ...
                                        while ($row_cat = mysqli_fetch_assoc($query)) {
