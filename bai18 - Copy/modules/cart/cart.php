...
?>
                ...
                <div id="my-cart">
                    ...
                    <div class="cart-item row">
                        ...
                        <div class="cart-price col-lg-3 col-md-3 col-sm-12"><b><?php echo number_format($cart[$row['prd_id']]*$row['prd_price'], 0, '.', '.'); ?></b><a href="modules/cart/del_cart.php?prd_id=<?php echo $row['prd_id']; ?>">Xóa</a></div>    
                    </div> 
                    <?php }?>
                    <div class="row">
                    	<div class="cart-thumb col-lg-7 col-md-7 col-sm-12">
